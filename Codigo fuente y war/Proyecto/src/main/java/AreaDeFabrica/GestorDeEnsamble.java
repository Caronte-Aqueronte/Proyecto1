...
public class GestorDeEnsamble {
    ...
    /**
     * Este metodo busca todas las coincidencias que senecuentren dentrode
     * latabla formula por medio del nombre del mueble
     *
     * @param nombreMueble
     * @return
     */
    public ResultSet buscarInstrucciones(String nombreMueble) {
        try {
            PreparedStatement query = CONEXION.prepareStatement(
                    "SELECT * FROM formula WHERE codigo_de_mueble like ?;");
    ...
    /**
     * Este metodo busca todas las instrucciones de la tabla formula
     *
     * @return
     */
    public ResultSet mostrarTodasLasInstrucciones() {
        try {
            PreparedStatement query = CONEXION.prepareStatement(
                    "SELECT * FROM formula;");
            ResultSet resultado = query.executeQuery();
