            ...
            try ( PrintWriter out = response.getWriter()) {
                ...
                if (request.getParameter("btnVentas") != null) {//si este boton fue activado entonces hacemos el reporte de ventas
                    ...
                    while (ventas.next()) {
                        ...
                        dineroEnVentas += ventas.getDouble("dinero_de_la_venta");
                    ...
                    while (respuesta.next()) {
                        ...
                        dineroDeLaVenta = respuesta.getDouble("dinero_de_la_venta");
                        codigoDeEnsambleVendido = respuesta.getInt("codigo_de_ensamble");
                        costoDeEnsambleDeVenta = GestorDeEnsamble.saberConstoDeEnsamble(codigoDeEnsambleVendido);
                        usuarioExiste = false;
                        for (VentaDeVendedor item : ventasDelVendedor) {//por cada tupla miramos si el vendedor exist en el array y sumamos sus ventas en caso de que si
                            if (item.getUsuarioDeVendedor().equalsIgnoreCase(nombreDelVendedor)) {//si los usuarios son iguales entonces existe ese vendedor en el arreglo
