        ...
        <nav class="navbar navbar-light" style="background-color: #393e41;">
            <form class="container-fluid justify-content-start">
                ...
                <div class="dropdown me-3">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                        <li><a href="/MiMuebleria/ControladorConsultaMueble" class="dropdown-item">Crear nuevo mueble/Crear una instruccion</a></li>
                        <li><a href="/MiMuebleria/ControladorConsultaUsuario" class="dropdown-item">Crear/cancelar usuario</a></li>
                    </ul>
                </div>
                <a href="carga-de-archivo.jsp" class="btn btn-outline-light me-3">Cargar un archivo</a>
                <a href="/MiMuebleria/CerrarSesion" " class="btn btn-danger float-right">Cerrar sesión</a>
            </form>  
        </nav>
    </body>
</html>
